...
const ProjectsPage = () => {
    ...
    return ( 
        <div className={`products-page ${darkMode ? 'dark-mode' : 'light-mode'}`}>
            <RightProjectDisplay darkMode={darkMode} imgPath={ViewDotaHomePage} displayLabel={"ViewDota"} about={aboutViewDota}/>
            <LeftProjectDisplay darkMode={darkMode}  imgPath={VolumeVisualizer} displayLabel={"Volume visualizer"} about={aboutVolumeVisualizer}/>
            <RightProjectDisplay darkMode={darkMode} imgPath={ConsoleBattleship} displayLabel={"Console Battleship"} about={aboutConsoleBattleship}/>
        </div>
    );
}
